...
public class PlaceholderCrossbowForge extends CrossbowItem {
    ...
    public PlaceholderCrossbowForge(String namespace, String path, int durability, double projectileDamage, int drawSpeed, float range) {
