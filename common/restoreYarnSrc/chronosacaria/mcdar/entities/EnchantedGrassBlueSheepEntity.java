...
public class EnchantedGrassBlueSheepEntity extends Sheep implements OwnableEntity, Summonable {
    @Nullable
    UUID ownerEntityUUID = null;

    public EnchantedGrassBlueSheepEntity(EntityType<? extends EnchantedGrassBlueSheepEntity> type, Level world) {
        super(type, world);
        this.setColor(DyeColor.BLUE);
    }

    public static AttributeSupplier.Builder createEnchantedBlueSheepEntityAttributes(){
