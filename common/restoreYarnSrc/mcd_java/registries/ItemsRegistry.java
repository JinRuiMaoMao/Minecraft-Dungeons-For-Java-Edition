...
public class ItemsRegistry {
    ...
    protected static Item registerItem(String id) {
        return registerItem(id, new Item(new Item.Properties()));
    }

    protected static Item registerItem(String id, Item newItem) {
        Item item = Registry.register(BuiltInRegistries.ITEM, Mcda.ID(id), newItem);
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.INGREDIENTS).register(entries -> entries.accept(item));
        return item;
    }
}