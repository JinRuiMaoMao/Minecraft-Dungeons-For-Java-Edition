...
public class ConfigItemEnabledCondition {
    ...
    public static void register() {
        ...
        ResourceConditions.register(new ResourceLocation(Mcdw.MOD_ID, "config_enabled"), jsonObject -> {
        ...
        ResourceConditions.register(new ResourceLocation(Mcdw.MOD_ID, "item_enabled"), jsonObject -> {
            JsonArray values = GsonHelper.getAsJsonArray(jsonObject, "values");
            ...
            for (JsonElement element : values) {
                if (element.isJsonPrimitive()) {
                    try {
                        ...
                        return BuiltInRegistries.ITEM.get(new ResourceLocation(element.getAsString())) != Items.AIR;
                    } catch (Exception e) {
                        throw new RuntimeException(e);
                    }
                }
