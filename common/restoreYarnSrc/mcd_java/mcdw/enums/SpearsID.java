...
public enum SpearsID implements IMeleeWeaponID, IInnateEnchantment {
    SPEAR_SPEAR(true, Tiers.IRON,4, -2.5f, "minecraft:iron_ingot"),
    SPEAR_WHISPERING_SPEAR(true, Tiers.IRON,5, -2.5f, "minecraft:iron_ingot"),
    SPEAR_FORTUNE(true, Tiers.IRON,5, -2.5f, "minecraft:iron_ingot");
    ...
    SpearsID(boolean isEnabled, Tier material, int damage, float attackSpeed, String... repairIngredient) {
    ...
    public Map<Enchantment, Integer> getInnateEnchantments() {
        return switch (this) {
            ...
            case SPEAR_FORTUNE -> CleanlinessHelper.mcdw$checkInnateEnchantmentEnabled(1, Enchantments.MOB_LOOTING);
        };
    }
