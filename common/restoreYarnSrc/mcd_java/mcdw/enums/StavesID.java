...
import mcd_java.mcdw.bases.McdwStaff;
...
public enum StavesID implements IMeleeWeaponID, IInnateEnchantment {
    STAFF_BATTLESTAFF(true, Tiers.WOOD,2, -2.6f, "minecraft:planks"),
    STAFF_BATTLESTAFF_OF_TERROR(true, Tiers.IRON,5, -2.6f, "minecraft:iron_ingot"),
    STAFF_GROWING_STAFF(true, Tiers.IRON,5, -2.6f, "minecraft:iron_ingot");
    ...
    StavesID(boolean isEnabled, Tier material, int damage, float attackSpeed, String... repairIngredient) {
