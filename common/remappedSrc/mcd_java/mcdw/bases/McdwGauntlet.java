...
import mcd_java.mcdw.enums.GauntletsID;
...
public class McdwGauntlet extends SwordItem implements IOffhandAttack, IInnateEnchantment {
    String[] repairIngredient;
    GauntletsID gauntletsEnum;
    public McdwGauntlet(GauntletsID gauntletsEnum, Tier material, int attackDamage, float attackSpeed, String[] repairIngredient) {
        super(material, attackDamage, attackSpeed,
                new Item.Properties().rarity(RarityHelper.fromToolMaterial(material)));
        this.gauntletsEnum = gauntletsEnum;
