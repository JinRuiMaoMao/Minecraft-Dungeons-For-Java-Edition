...
import mcd_java.mcdw.bases.McdwScythe;
...
public enum ScythesID implements IMeleeWeaponID, IInnateEnchantment {
    SCYTHE_FROST_SCYTHE(true, Tiers.DIAMOND,4, -2.9f, "minecraft:diamond"),
    SCYTHE_JAILORS_SCYTHE(true, Tiers.IRON,4, -2.9f, "minecraft:iron_ingot"),
    SCYTHE_SKULL_SCYTHE(true, Tiers.DIAMOND,4, -2.9f, "minecraft:diamond"),
    SCYTHE_SOUL_SCYTHE(true, Tiers.DIAMOND,3, -2.9f, "minecraft:diamond");
    ...
    ScythesID(boolean isEnabled, Tier material, int damage, float attackSpeed, String... repairIngredient) {
