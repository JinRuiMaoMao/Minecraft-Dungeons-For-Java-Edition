...
import mcd_java.mcdw.bases.McdwWhip;
...
public enum WhipsID implements IMeleeWeaponID, IInnateEnchantment {
    WHIP_VINE_WHIP(true, Tiers.IRON, 5, -3.1f, "minecraft:vine"),
    WHIP_WHIP(true, Tiers.IRON, 3, -3.1f, "minecraft:string");
    ...
    WhipsID(boolean isEnabled, Tier material, int damage, float attackSpeed, String... repairIngredient) {
