...
public class EnchantedGrassGreenSheepEntity extends Sheep implements OwnableEntity, Summonable {

    @Nullable
    UUID ownerEntityUUID = null;

    public EnchantedGrassGreenSheepEntity(EntityType<? extends EnchantedGrassGreenSheepEntity> type, Level world) {
        super(type, world);
        this.setColor(DyeColor.GREEN);
    }

    public static AttributeSupplier.Builder createEnchantedGreenSheepEntityAttributes(){
    ...
    protected void registerGoals(){
        ...
        this.goalSelector.addGoal(4, eatGrassGoal);
