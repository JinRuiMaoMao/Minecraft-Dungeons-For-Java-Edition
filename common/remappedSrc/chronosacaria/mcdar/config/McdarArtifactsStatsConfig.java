...
public class McdarArtifactsStatsConfig implements ConfigData {
    ...
    public McdarArtifactsStatsConfig() {
        Set<String> villager = GroupedObjectsHelper.VILLAGER_ARTIFACT_GENERAL_LOOT_TABLES.stream().map(ResourceLocation::toString).collect(Collectors.toSet());
        Set<String> illager = GroupedObjectsHelper.ILLAGER_ARTIFACT_GENERAL_LOOT_TABLES.stream().map(ResourceLocation::toString).collect(Collectors.toSet());
        Set<String> dungeon = GroupedObjectsHelper.ALL_ARTIFACTS_DUNGEON_LOOT_TABLES.stream().map(ResourceLocation::toString).collect(Collectors.toSet());
