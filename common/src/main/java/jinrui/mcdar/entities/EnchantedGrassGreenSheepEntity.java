...
public class EnchantedGrassGreenSheepEntity extends SheepEntity implements OwnableSummon {
    ...
    protected void initGoals() {
        ...
        this.goals.add(4, eatGrassGoal);
        this.goals.add(5, new MeleeAttackGoal(this, 1.0D, true));
