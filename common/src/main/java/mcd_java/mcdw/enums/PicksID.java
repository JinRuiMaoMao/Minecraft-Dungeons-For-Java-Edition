...
import mcd_java.mcdw.bases.McdwPick;
...
public enum PicksID implements IMeleeWeaponID {
    PICK_DIAMOND_PICKAXE_VAR(true, Tiers.DIAMOND,1, -2.8f, "minecraft:diamond"),
    PICK_HAILING_PINNACLE(true, Tiers.DIAMOND,1, -2.8f, "minecraft:diamond"),
    PICK_HOWLING_PICK(true, Tiers.IRON,1, -2.8f, "minecraft:iron_ingot"),
    PICK_MOUNTAINEER_PICK(true, Tiers.IRON,1, -2.8f, "minecraft:iron_ingot");
    ...
    PicksID(boolean isEnabled, Tier material, int damage, float attackSpeed, String... repairIngredient) {
