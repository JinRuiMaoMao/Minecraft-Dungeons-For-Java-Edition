...
import mcd_java.mcdw.bases.McdwGauntlet;
...
public enum GauntletsID implements IMeleeWeaponID, IInnateEnchantment {
    GAUNTLET_GAUNTLET(true, Tiers.IRON,0, -1.5f, "minecraft:iron_ingot"),
    GAUNTLET_MAULERS(true, Tiers.DIAMOND,1, -1.5f, "minecraft:diamond"),
    GAUNTLET_SOUL_FISTS(true, Tiers.NETHERITE,0, -1.5f, "minecraft:netherite_scrap");
    ...
    GauntletsID(boolean isEnabled, Tier material, int damage, float attackSpeed, String... repairIngredient) {
