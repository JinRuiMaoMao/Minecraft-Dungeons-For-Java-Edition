...
import mcd_java.mcdw.bases.McdwSickle;
...
public enum SicklesID implements IMeleeWeaponID, IInnateEnchantment {
    SICKLE_LAST_LAUGH_GOLD(true, Tiers.IRON,2, -2.1f, "minecraft:iron_ingot"),
    SICKLE_LAST_LAUGH_SILVER(true, Tiers.IRON,2, -2.1f, "minecraft:iron_ingot"),
    SICKLE_NIGHTMARES_BITE(true, Tiers.IRON,2, -2.1f, "minecraft:iron_ingot"),
    SICKLE_SICKLE(true, Tiers.IRON,1, -2.1f, "minecraft:iron_ingot");
    ...
    SicklesID(boolean isEnabled, Tier material, int damage, float attackSpeed, String... repairIngredient) {
