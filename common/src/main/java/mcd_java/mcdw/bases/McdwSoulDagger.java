...
import mcd_java.mcdw.enums.SoulDaggersID;
...
public class McdwSoulDagger extends SwordItem implements IInnateEnchantment {
    ...
    public McdwSoulDagger(SoulDaggersID soulDaggersEnum, Tier material, int attackDamage, float attackSpeed, String[] repairIngredient) {
