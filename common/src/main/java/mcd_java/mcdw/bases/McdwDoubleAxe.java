...
import mcd_java.mcdw.enums.DoubleAxesID;
...
public class McdwDoubleAxe extends AxeItem implements IInnateEnchantment {
    ...
    public McdwDoubleAxe(DoubleAxesID doubleAxesEnum, Tier material, float attackDamage, float attackSpeed, String[] repairIngredient){
