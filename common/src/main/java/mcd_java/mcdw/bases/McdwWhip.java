...
import mcd_java.mcdw.enums.WhipsID;
...
public class McdwWhip extends McdwCustomWeaponBase implements Vanishable, IInnateEnchantment {
    ...
    public McdwWhip(WhipsID whipsEnum, Tier material, int attackDamage, float attackSpeed, String[] repairIngredient) {
