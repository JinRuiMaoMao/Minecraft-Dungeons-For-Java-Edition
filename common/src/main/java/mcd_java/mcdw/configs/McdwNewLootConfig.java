...
public class McdwNewLootConfig implements ConfigData {
    ...
    public McdwNewLootConfig(){
        ...
        //DOUBLE AXES
        DOUBLE_AXE_SPAWN_RATES.put(DoubleAxesID.DOUBLE_AXE_DOUBLE, 10);
        DOUBLE_AXE_SPAWN_RATES.put(DoubleAxesID.DOUBLE_AXE_CURSED, 5);
        DOUBLE_AXE_SPAWN_RATES.put(DoubleAxesID.DOUBLE_AXE_WHIRLWIND, 5);
        ...
        //GLAIVES
        GLAIVE_SPAWN_RATES.put(GlaivesID.GLAIVE_GLAIVE, 10);
        GLAIVE_SPAWN_RATES.put(GlaivesID.GLAIVE_GRAVE_BANE, 5);
        GLAIVE_SPAWN_RATES.put(GlaivesID.GLAIVE_VENOM_GLAIVE, 5);
        GLAIVE_SPAWN_RATES.put(GlaivesID.GLAIVE_CACKLING_BROOM, 5);
        ...
        //SCYTHES
        SCYTHE_SPAWN_RATES.put(ScythesID.SCYTHE_JAILORS_SCYTHE, 10);
        SCYTHE_SPAWN_RATES.put(ScythesID.SCYTHE_SOUL_SCYTHE, 5);
        SCYTHE_SPAWN_RATES.put(ScythesID.SCYTHE_FROST_SCYTHE, 5);
        SCYTHE_SPAWN_RATES.put(ScythesID.SCYTHE_SKULL_SCYTHE, 5);
        ...
        //SOUL DAGGERS
        SOUL_DAGGER_SPAWN_RATES.put(SoulDaggersID.SOUL_DAGGER_SOUL_KNIFE, 10);
        SOUL_DAGGER_SPAWN_RATES.put(SoulDaggersID.SOUL_DAGGER_ETERNAL_KNIFE, 5);
        SOUL_DAGGER_SPAWN_RATES.put(SoulDaggersID.SOUL_DAGGER_TRUTHSEEKER, 5);
