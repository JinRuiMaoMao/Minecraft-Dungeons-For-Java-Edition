...
public class McdwClient implements ClientModInitializer {
    ...
    public static void registerRangedWeaponPredicates(Item item) {
        ItemProperties.register(item, new Identifier("pull"), (itemStack, clientWorld, livingEntity, seed) -> {
        ...
        if (item instanceof BowItem) {
            ItemProperties.register(item, new Identifier("pulling"), (itemStack, clientWorld, livingEntity, seed) ->
        ...
        if (item instanceof CrossbowItem) {
            ...
            ItemProperties.register(item, new Identifier("charged"), (itemStack, clientWorld, livingEntity, seed) -> {
                if (livingEntity == null) {
                    return 0.0F;
                } else {
            ...
            ItemProperties.register(item, new Identifier("firework"), (itemStack, clientWorld, livingEntity, seed) -> {
                if (livingEntity == null) {
                    return 0.0F;
                } else {
    ...
    public static void registerShieldPredicates(McdwShield shield) {
        ItemProperties.register(shield, new Identifier("blocking"),
