...
import mcd_java.mcda.registries.ItemsRegistry;
...
public enum ArmorSets implements ArmorMaterial {
    ...
    ArmorSets(String textureName, String setName, int enchantability,
        ...
        this.repairIngredient =  Suppliers.memoize(() -> Ingredient.of(items));
    }
    ...
    public int getDurabilityForType(ArmorItem.Type type) {
        return baseDurability[type.getSlot().getIndex()] * Mcda.CONFIG.mcdaArmorStatsConfig.armorStats.get(this).durabilityMultiplier;
    }

    @Override
    public int getDefenseForType(ArmorItem.Type type) {
        return Mcda.CONFIG.mcdaArmorStatsConfig.armorStats.get(this).protection.get(type.getSlot());
    }
