...
public class PlaceholderCrossbowFabric extends CrossbowItem {
    ...
    public PlaceholderCrossbowFabric(String namespace, String path, int maxDamage, double projectileDamage, int drawSpeed, float range) {
